...
const Navbar = () => {
  ...
  const isAdmin = true;
  return (
    <header className="fixed min-w-screen top-0 left-0 bg-gray-900 bg-opacity-90 backdrop-blur-md shadow-lg z-40 transition-all duration-300 border-b border-emerald-800">
          ...
          <nav className="flex flex-wrap items-center gap-4">
            ...
            {user ? (
              ...
              <>
                ...
                >
                  <UserPlus className="mr-2" size={10} />
                  Sign Up
                </Link>
                <Link
                  to={"/login"}
                ...
                >
                  <LogInIcon className="mr-2" size={10} />
                  Login
                </Link>
              </>
            )}
